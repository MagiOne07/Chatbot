...
if select == "About":
    ...
    txt = s.text_area('Othmane: ', '''
     ...
     It is excellent at doing 3 main things: 
      ...
      3- Reporting live stock market data: For investment lovers, you can simply ask the chatbot for stock market data and it will provide you with what you are looking for including a buy/sell suggestion.
      This chatbot can also have basic conversations about daily life matters including a variety of topics, you can ask the chatbot information about itself as well, and enjoy an entertaining conversation. 
            ...
            if s.session_state.status == True:
                ...
                if inp != "stop":
                    ...
                    if news>0.5:
                        ...
                        news= "positive. You might want to Buy, but if I were you I would wait until more convincing news comes out."
                    elif news<0:
                        news= "negative. You might want to Sell, but if I were you I would wait until more convincing news comes out."
                    try:
                        actual = actual[0]
    ...
    #print(Fore.YELLOW + "I am Othmane your bot companion. I can tell you jokes, play riddles and I will do my best to answer your questions. Tell me what you want to do?" + Style.RESET_ALL)
    s.write('ChatBot: I am Othmane your bot companion. I can tell you jokes, play riddles and I will do my best to answer your questions. Tell me what you want to do?')
    chat()